...
module MdEmoji
  ...
  basketball bath bathtub battery bear beer beers beetle beginner bell bento bicyclist bike bikini
  bird birthday black_circle black_joker black_large_square black_medium_small_square black_medium_square
  black_nib black_small_square black_square black_square_button blossom blowfish blue_book blue_car
  blue_heart blush boar boat bomb book bookmark bookmark_tabs books boom boot bouquet bow bowling bowtie
  ...
  couplekiss cow cow2 credit_card crescent_moon crocodile crossed_flags crown cry crying_cat_face
  crystal_ball cupid curly_loop currency_exchange curry custard customs cyclone dancer dancers dango
  dart dash date de deciduous_tree department_store diamond_shape_with_a_dot_inside diamonds disappointed
  ...
  package page_with_curl pager palm_tree panda_face paperclip parking part_alternation_mark partly_sunny
  ...
  wedding whale whale2 wheelchair white_check_mark white_circle white_flower white_medium_small_square
  white_medium_square white_large_square white_small_square white_square white_square_button wind_chime
  wine_glass wink wink2 wolf woman womans_clothes womans_hat womens worried wrench x yellow_heart yen
  yum zap zero zzz}
end
